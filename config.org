...
#+begin_src elisp
  (use-package general
    ...
    (ECFPAW/leader-keys
      ...
      "w v" '(evil-window-vsplit :wk "Vertical split window") ;; both of 
      "w /" '(evil-window-vsplit :wk "Vertical split window") ;; these do the samething but I really like the second keybinding.
