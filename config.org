...
#+begin_src elisp
  (use-package general
    ...
    (ECFPAW/leader-keys
      ...
      "f c" '((lambda () (interactive) (find-file (get-file-user-config "config.org"))) :wk "Edit emacs config")
      "f r" '(counsel-recentf :wk "Find recent files")
      "f e r" '((lambda () (interactive) (get-file-user-config "init.el")) :wk "Reload emacs config"))
...
#+begin_src elisp
  (use-package dashboard
    ...
    (setq dashboard-startup-banner (get-file-user-config "images/trancendent-gnu.png"))
...
* CUSTOM
#+begin_src elisp
  (defsubst get-file-user-config(file) (concat user-emacs-directory file))
#+end_src
