...
#+begin_src elisp
  (with-eval-after-load 'ECFPAW/leader-keys
      (ECFPAW/leader-keys
...
#+begin_src elisp
  ...
  (ECFPAW/leader-keys
    ...
    "f c" '((lambda () (interactive) (find-file
                                 (locate-user-emacs-file "config.org")))
            :wk "Edit emacs config")
    "f r" '(recentf :wk "Find recent files")
    "f e r" '((lambda () (interactive) (load-file
...
:TODO:
+ [-] Things that need to implemented [2/4]
  + [ ] C-c C-c support for custom cookies
    + [ ] Stop other org-ctrl-c-ctrl-c functions from running if our
...
#+begin_src elisp
  (use-package org-custom-cookies
    ...
    (defun ECFPAW/org-custom-cookie-ctrl-c-ctrl-c ()
      "Add Ctrl-c Ctrl-c support for custom org cookies."
    ...
    (add-hook 'org-ctrl-c-ctrl-c-hook 'ECFPAW/org-custom-cookie-ctrl-c-ctrl-c)

    (org-custom-cookies--enable-cookie-face-for-all-custom-cookies))
#+end_src
*** Subheading counting
