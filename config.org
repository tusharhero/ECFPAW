...
#+begin_src elisp
  (ECFPAW/leader-keys
    ...
    "P" '(perspective-map :wk "Perspective") ;; Lists all the perspective keybindings
...
#+begin_src elisp
  ...
  (defvar ECFPAW/mode-line/mini-format
    ...
    (defvar-local ECFPAW/mode-line/time
        '(:eval 
          (propertize (current-time-string) 'face 'ECFPAW/mode-line/buffer-name-face))
...
#+begin_src elisp
  (use-package perspective
    :custom
    ;; NOTE! I have also set 'SCP P' to open the perspective menu.
