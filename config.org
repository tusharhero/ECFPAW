...
#+begin_src elisp
  (use-package general
    ...
    (ECFPAW/leader-keys
      ...
      "f e r" '((lambda () (interactive) (locate-user-emacs-file "init.el")) :wk "Reload emacs config"))
...
* TRANSPARENCY
With Emacs version 29, true transparency has been added. For now I
have disabled transparency.
#+begin_src elisp
